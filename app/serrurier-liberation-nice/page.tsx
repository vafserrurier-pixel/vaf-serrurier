...
const blocks = [
  ...
  },
  {
    ...
    paragraphs: [
      <>
            Pour les halls d&apos;immeuble et parties communes du quartier, j&apos;interviens sur demande d&apos;un <Link href="/agences-syndics-nice/" className="text-steel underline">syndic</Link> ou d&apos;un résident mandaté : réglage de porte, remplacement de gâche électrique, digicode défectueux.
          </>,
    ],
  },
  {

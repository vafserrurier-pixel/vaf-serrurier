...
const intro = [
  ...
  "Le quartier tient son nom de ses rues, toutes baptisées en hommage à des compositeurs — Mozart, Verdi, Berlioz, Rossini, Gounod, Beethoven — et s'est développé à la fin du XIXe siècle après l'arrivée du chemin de fer, quand la haute société recherchait des immeubles élégants près de la gare. Simone Veil elle-même évoquait dans ses mémoires l'immeuble bourgeois du quartier que ses parents avaient dû quitter à la fin des années 1920 : ce patrimoine explique la densité de portes et de serrures anciennes du secteur.",
];

...
const intro = [
  ...
  "Saint-Isidore tire son nom d'Isidore le Laboureur, saint espagnol vénéré pour son lien avec la terre — une procession perpétue encore chaque année en avril cette dévotion. À l'origine relais de diligences, le quartier abrite aujourd'hui le Musée National du Sport et le stade Allianz Riviera qui accueille l'OGC Nice. Ces équipements représentent la facette contemporaine de ce secteur à l'habitat plus récent, qui mêle résidences neuves et quelques maisons individuelles, entre le chemin de la Ginestière, la route de Grenoble et l'église Saint-Isidore, désormais desservi par la ligne 3 du tramway.",
];

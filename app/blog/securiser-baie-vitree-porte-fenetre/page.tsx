    ...
    <article className="mx-auto max-w-3xl px-4 py-10">
      <Breadcrumbs
        items={[
          { name: "Accueil", href: "/" },
          { name: "Blog", href: "/blog/" },
          { name: "TODO : titre court", href: "/blog/securiser-baie-vitree-porte-fenetre/" },
        ]}
      />
      ...
      {/*
        ...
        Sécuriser une baie vitrée ou une porte-fenêtre : ce qui existe réellement (verrou additionnel, vitrage, volet), sans détail de méthode d'effraction.

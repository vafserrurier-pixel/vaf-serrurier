        ...
        <div className="mx-auto max-w-3xl px-4 py-10">
          ...
          <div className="mt-8">
            <ArticleSummary
              points={[
                <>
                  <strong>Ne touchez à rien</strong> avant le passage de la police : les traces laissées sont des preuves utiles.
                </>,
                "Faites opposition sur vos moyens de paiement disparus, puis portez plainte sous 48h.",
                <>
                  La loi impose <strong>2 jours ouvrés</strong> pour déclarer un cambriolage à votre assurance, pas plus.
                </>,
          ...
          <ArticleLayout toc={toc}>
            ...
            <div>
              ...
              <p className="text-slate leading-relaxed">
                ...
                un cambriolage, contre 5 jours pour la plupart des autres sinistres.
                Transmettez une copie du dépôt de plainte et une déclaration écrite

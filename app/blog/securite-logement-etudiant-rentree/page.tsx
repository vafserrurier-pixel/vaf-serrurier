    ...
    <article className="mx-auto max-w-3xl px-4 py-10">
      <Breadcrumbs
        items={[
          { name: "Accueil", href: "/" },
          { name: "Blog", href: "/blog/" },
          { name: "TODO : titre court", href: "/blog/securite-logement-etudiant-rentree/" },
        ]}
      />
      ...
      {/*
        ...
        Sécurité du logement étudiant à la rentrée : premiers réflexes pour un studio ou une colocation, ce qui est à la charge du propriétaire.

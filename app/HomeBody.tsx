...
const strings = {
  fr: {
    ...
    crimeText:
      "Selon les chiffres du ministère de l'Intérieur publiés en mars 2026, le taux de cambriolages à Nice est remonté à 0,61% des logements en 2025, contre 0,54% l'année précédente. Ce niveau est désormais supérieur à la moyenne nationale (0,56%), et bien au-dessus de la moyenne du département des Alpes-Maritimes (0,43%). Une porte correctement équipée reste le moyen le plus direct de limiter ce risque, où que vous soyez dans la ville.",
  ...
  en: {
    ...
    crimeText:
      "According to figures from the French Interior Ministry published in March 2026, the burglary rate in Nice rose to 0.61% of homes in 2025, up from 0.54% the previous year. That level is now above the national average (0.56%), and well above the average for the Alpes-Maritimes département (0.43%). A properly fitted door remains the most direct way to limit this risk, wherever you are in the city.",

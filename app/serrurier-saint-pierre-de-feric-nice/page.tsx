...
const intro = [
  ...
  "Le nom du quartier vient du niçois « San Peire dei Ferigoula », littéralement « Saint Pierre des Thyms », en référence aux plantations de thym qui couvraient autrefois ces hauteurs. Longtemps rural, le secteur est resté agricole jusqu'à la création d'un réseau de routes en 1922, ce village des hauteurs étant aujourd'hui traversé par l'autoroute A8, qui y passe en tunnel sur 220 mètres. Il s'est ensuite urbanisé fortement, tout en conservant son caractère calme et verdoyant, avec des villas entourées de jardins, parfois piscine ou court de tennis à l'appui.",
];

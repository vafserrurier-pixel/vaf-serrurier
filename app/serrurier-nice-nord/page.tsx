...
const intro = [
  ...
  "Saint-Pancrace et sa chapelle du XVIIe siècle témoignent d'un passé rural de vignes et de cultures méditerranéennes. Pessicart, mentionné dès le cadastre napoléonien de 1812, est devenu de son côté un quartier résidentiel calme apprécié pour sa vue sur la ville. Le Brancolar, enfin, connaît depuis le départ d'Enedis de son ancien site en 2021 une transformation urbaine avec de nouveaux programmes résidentiels.",

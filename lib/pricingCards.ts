...
export const cardsByLocale: Record<Locale, PricingCard[]> = {
  fr: [
    ...
    },
    {
      ...
      priceType: "fixed",
      features: [
        "Configuration de référence : blindage avec serrure 5 points en applique",
        "Conserve votre porte existante, garantie fabricant 15 ans",
        "Devis sur place systématique selon le modèle choisi",
      ],
      featured: true,
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      priceType: "fixed",
      features: [
        "Reference configuration: reinforcement with a 5-point rim lock",
